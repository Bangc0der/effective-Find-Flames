...
import 'package:tutorial/edit.dart';
import 'package:tutorial/qr.dart';
import 'package:tutorial/setting.dart';
          ...
          SizedBox( 
            ...
            child:ElevatedButton(
              ...
              child: const Column(children: [
                  SizedBox(height:14,),
                  IconButton(onPressed:null ,icon:Icon(Icons.settings ,size:26,color:Color.fromARGB(255, 107, 106, 107),),),
                  Text('Settings',style:TextStyle(color: Color.fromARGB(255, 107, 106, 107),fontSize:12)),
                  SizedBox(height:14,),
              ],),
          ...
          SizedBox( 
            ...
            child:ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  ...
                  child: const Column(children: [
                  SizedBox(height:14,),
                  IconButton(onPressed:null ,icon:const Icon(Icons.qr_code,size:26,color:Color.fromARGB(255, 107, 106, 107),),),
                  Text('QR Code',style:TextStyle(color: Color.fromARGB(255, 107, 106, 107),fontSize:12)),
                  SizedBox(height:14,),
              ],),
                      onPressed: (){  Navigator.push(context, MaterialPageRoute(builder: (context)=> QRScreen()));}
                  //parameters of Button class
            ),),
          const SizedBox(width:10,),
        ],),
